...
export async function listBookingByHotel(req: AuthenticatedRequest, res: Response, next: NextFunction) {
  try {
    const { hotelId } = req.params;
    const bookings = await bookingService.getBookingByHotel(Number(hotelId));
